...
namespace AutoExile.Systems
{
    ...
    public class LootSystem
    {
        ...
        public bool StartLabelToggle(GameController gc)
        {
            ...
            _preToggleLabelCount = gc.IngameState.IngameUi.ItemsOnGroundLabelsVisible?.Count ?? 0;
        ...
        public bool TickLabelToggle(GameController gc)
        {
            ...
            if (elapsed > 3000)
            {
                ...
                var currentCount = gc.IngameState.IngameUi.ItemsOnGroundLabelsVisible?.Count ?? 0;
